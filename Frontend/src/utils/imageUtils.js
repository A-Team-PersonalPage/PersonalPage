export const getImageForPlace = (placeName) => {
  switch (placeName) {
    ...
    case "스위스":
      return "https://learninswitzerland.com/wp-content/uploads/2016/05/3517_original-800x500.jpg";
    case "파리":
      return "https://i.namu.wiki/i/LFRIiqAJzEUKx0dbsftnohx78BLrGv9qznkKtCUTyephVHhu9gYo3pRs_7YyBnDNBo_6ttVnBw1AZ5KZgbH6tw.webp";
    case "일본":
      return "https://narita-airport.imagewave.pictures/DukuU7jHfRwFC557Ci3gEX";
    default:
