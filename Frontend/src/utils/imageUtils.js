export const getImageForPlace = (placeName) => {
  switch (placeName) {
    ...
    case '미국':
      return 'https://cdn.pixabay.com/photo/2014/02/17/10/20/statue-of-liberty-267948_1280.jpg';
    case '일본':
      return 'https://cdn.pixabay.com/photo/2023/01/08/08/40/road-7704729_1280.jpg';
    default:
