        ...
        <div className="likes_container">
          ...
          {viewAllTags && (
            <div className="all_tags_container">
              <div
                className={`tags ${activeTag.includes("힐링") ? "active" : ""}`}
                onClick={() => toggleTag("힐링")}
              >
                힐링
              </div>
              <div
                className={`tags ${
                  activeTag.includes("활동적인") ? "active" : ""
                }`}
                onClick={() => toggleTag("활동적인")}
              >
                활동적인
              </div>
              <div
                className={`tags ${
                  activeTag.includes("친구들과 함께하는") ? "active" : ""
                }`}
                onClick={() => toggleTag("친구들과 함께하는")}
              >
                친구들과 함께하는
              </div>
              <div
                className={`tags ${
                  activeTag.includes("부모님과 함께하는") ? "active" : ""
                }`}
                onClick={() => toggleTag("부모님과 함께하는")}
              >
                부모님과 함께하는
              </div>
            </div>
